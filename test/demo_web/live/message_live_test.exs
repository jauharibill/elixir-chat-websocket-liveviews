defmodule DemoWeb.MessageLiveTest do
  use DemoWeb.ConnCase

  import Phoenix.LiveViewTest
  import Demo.ChatFixtures

  @create_attrs %{datetime: "some datetime", sender: "some sender", text: "some text"}
  ...
  describe "Index" do
    ...
    test "updates message in listing", %{conn: conn, message: message} do
      ...
      assert html =~ "some updated datetime"
    end
